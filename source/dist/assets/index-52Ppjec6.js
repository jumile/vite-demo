import{l as c}from"./logo-desktop-DIzKdvXn.js";function o(){const l=document.querySelectorAll(".taste__button"),a=document.querySelectorAll(".widget__list-img"),e=document.querySelectorAll(".name");l.forEach((n,i)=>{n.addEventListener("click",()=>{a.forEach(t=>{t.classList.remove("widget__list-img--current")}),e.forEach(t=>{t.classList.remove("name--current")}),a.forEach((t,s)=>{s===i&&t.classList.add("widget__list-img--current")}),e.forEach((t,s)=>{s===i&&t.classList.add("name--current")})})})}o();const _="/assets/cones-desktop-BIqpOHLy.png",r="/assets/cocktail-desktop-XOjg_6Lx.png",g="/assets/eskimo-desktop-DttLYxbx.png",p="/assets/wafel-desktop-B1yjAai4.png",m="/assets/blueberry-D8KnbK00.png",u="/assets/chocolate-BRzv2X9u.png",b="/assets/fistashki-DmY2SWgm.png",h="/assets/mango-BisK1t1M.png",d="/assets/strawberry-DaUOCwfZ.png",w="/assets/vanilla-BGUp25g2.png",f={BASE_URL:"/",DEV:!1,MODE:"staging",PROD:!0,SSR:!1,VITE_API_URL:"https://gladiols.ru/api",VITE_APP_NAME:"Ice"};document.querySelector("#app").innerHTML=`
<header class="header">
<picture>
  <source srcset="images/logo-mobile.svg" width="41" height="39" media="(max-width: 767px)">
  <img class="logo" src="${c}" alt="Логотип" width="150" height="150">
</picture>
...
<section class="select" id="catalog">
  <div class="wrapper">
    ...
    <ul class="select__list">
      <li>
        <img src="${_}" alt="Шарики мороженого в вафельных конусах" width="344" height="220">
        <h3>Шарики</h3>
        <p>Шарики мороженого в&nbsp;ассортименте с&nbsp;топингом на&nbsp;выбор.</p>
        <a href="catalog.html"></a>
      </li>
      <li>
        <img src="${r}" alt="Коктейли с фруктами" width="344" height="242">
        <h3>Коктейли</h3>
        <p>Натуральное молоко и свежие фрукты - вот рецепт идеального коктейля.</p>
        <a href="catalog.html"></a>
      </li>
      <li>
        <img src="${g}" alt="Шарики мороженого в вафельных конусах" width="344" height="224">
        <h3>Эскимо</h3>
  ...
  <div class="wrapper best__wrapper">
    ...
    <div class="widget">
      <ul class="widget__list">
        <li><img class="widget__list-img widget__list-img--vanilla" src="${w}"
            alt="Шарик ванильного мороженого" width="127" height="107"></li>
        <li><img class="widget__list-img widget__list-img--blueberry" src="${m}"
            alt="Шарик черничного мороженого" width="153" height="139"></li>
        <li><img class="widget__list-img widget__list-img--chocolate" src="${u}"
            alt="Шарик шоколадного мороженого" width="129" height="117"></li>
        <li><img class="widget__list-img widget__list-img--strawberry" src="${d}"
            alt="Шарик клубничного мороженого" width="134" height="120"></li>
        <li><img class="widget__list-img widget__list-img--fistashki" src="${b}"
            alt="Шарик фисташкового мороженого" width="128" height="119"></li>
        <li><img class="widget__list-img widget__list-img--mango widget__list-img--current" src="${h}"
            alt="Шарик мороженого с манго" width="129" height="129"></li>
      </ul>
      <div class="widget__wafel-wrapper">
        <img class="widget__wafel" src="${p}" alt="Вафельный рожок" width="616" height="560">
      </div>
    </div>
    <ul class="name-list">
...
`;console.log(f);
//# sourceMappingURL=index-52Ppjec6.js.map
