import{l}from"./logo-desktop-DIzKdvXn.js";document.querySelector("#app").innerHTML=`
<header class="header">
    <div class="wrapper">
      <a href="/">
        <picture>
          <source srcset="images/logo-mobile.svg" width="41" height="39" media="(max-width: 767px)">
          <img class="logo" src="${l}" alt="Логотип" width="131" height="131">
        </picture>
      </a>
...
`;
//# sourceMappingURL=catalog-C62twmuR.js.map
